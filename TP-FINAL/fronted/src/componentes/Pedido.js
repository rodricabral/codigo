...
function Pedido() {
  ...
  const [productoListDB, setProductoListDB] = useState([]);
              ...
              <div className="col-9">
                ...
                {/* <Autocomplete
                  ...
                  onChange={(event, newValue) => {
                    ...
                    setSelectedProducto(newValue.nombre);

                    console.log(selectedProducto)
                    // Actualiza pedidoForm.productoNombre si es necesario
                    setPedidoForm({
                      ...pedidoForm,
                      productoNombre: newValue?.nombre,
                    });
                  }}
                  renderInput={(params) => (
                    <TextField
