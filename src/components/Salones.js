...
export default function Salones() {
    ...
    const saveProduct = () => {
        ...
        if(product.id){
            axios.put('http://localhost:3001/salon/' + product.id, product).then((response)=>{
                setProductDialog(false)
                getSalones()
                toast.current.show({ severity: 'success', summary: 'Successful', detail: 'Product Update', life: 3000 });
            })
        }else{
            axios.post('http://localhost:3001/salon', product).then(()=>{
                setProductDialog(false)
                getSalones()
    ...
    const deleteProduct = () => {
        ...
        axios.delete('http://localhost:3001/salon/' + product.id).then(()=>{
            setDeleteProductDialog(false);
            getSalones()
            setProduct(emptyProduct);
        ...
        <div className='container mt-5 mb-5'>
            ...
            <div className="card">
                ...
                <DataTable ref={dt} value={products} selection={selectedProducts}
                    ...
                    <Column field="capacidad" header="Capacidad" sortable style={{ minWidth: '16rem' }}></Column>
            ...
            <Dialog visible={productDialog} style={{ width: '32rem' }} breakpoints={{ '960px': '75vw', '641px': '90vw' }} header="Product Details" modal className="p-fluid" footer={productDialogFooter} onHide={hideDialog}>
                ...
                <div className="field">
                    ...
                    <div className="field">
                        ...
                        <InputNumber id="capacidad" value={product.capacidad} onValueChange={(e) => onInputNumberChange(e, 'capacidad')} />
                    </div>
